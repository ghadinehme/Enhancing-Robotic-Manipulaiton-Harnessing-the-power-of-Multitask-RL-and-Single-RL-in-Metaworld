...
#             reward = reward[0]
    ...
    # Rendering here
    def render(self, mode="rgb_array", offscreen = False):
        # print('Here')
        return self.gym_env.render(offscreen=offscreen)
...
class ActionDTypeWrapper(dm_env.Environment):
    ...
    def step(self, action):
        ...
        temp = self._env.step(action)
        # print('Inside ActionDtypeWrapper')
        # print(temp)
        return temp
    ...
    def end_effector(self):
       return self._env.gym_env.get_endeff_pos()
